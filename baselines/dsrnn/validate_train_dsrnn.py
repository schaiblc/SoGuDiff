...
def main():
	config = Config()
	config.training.output_dir = 'data/validate_DSRNN'
	config.training.num_env_steps = 5000000
	config.training.use_linear_lr_decay = False  # keep LR at initial (worst-case) value throughout, stricter stability test
