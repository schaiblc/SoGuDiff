...
class Agent(object):
    def __init__(self, config, section):
        ...
        # will be overwritten in pybullet env only, otherwise is always None
        self.uid = None
    ...
    def get_changing_state_list(self):
        return [self.px, self.py, self.gx, self.gy, self.theta]
    def get_changing_state_list_goal_offset(self):
        return [self.gx - self.px, self.gy - self.py, self.theta]
    ...
    def step(self, action):
        ...
        if self.kinematics == 'holonomic':
            ...
            print("Don't use this function to step Turtlebot! Use PyBullet functions instead")
